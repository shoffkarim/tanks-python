...
class Tank():
	...
	def __init__(self, level, side, position=None, direction=None, filename=None):
		...
		# скорость
		self.speed = 2
		# сколько пуль одновременно можно выстрелить
